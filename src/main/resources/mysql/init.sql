-- 项目数库
DROP DATABASE IF EXISTS work_collaborative_images;
CREATE DATABASE work_collaborative_images CHARACTER SET utf8mb4 COLLATE = utf8mb4_unicode_ci;
USE work_collaborative_images;

-- 项目用户
DROP USER IF EXISTS 'wci'@'%';
CREATE USER 'wci'@'%' IDENTIFIED BY 'Qwe54188_';
GRANT ALL PRIVILEGES ON work_collaborative_images.* TO 'wci'@'%';
FLUSH PRIVILEGES;
...
VALUES ('aimou', 'wx_union_aimou', 'mp_open_aimou', 'aimou@example.com', '13800138001', '370101198701012345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'aimou', '艾梦',
       ...
       ('bimou', 'wx_union_bimou', 'mp_open_bimou', 'bimou@example.com', '13800138002', '370101198802022345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'bimou', '白萌',
       ...
       ('cimou', 'wx_union_cimou', 'mp_open_cimou', 'cimou@example.com', '13800138003', '370101198903032345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'cimou', '陈明',
       ...
       ('dimou', 'wx_union_dimou', 'mp_open_dimou', 'dimou@example.com', '13800138004', '370101199004042345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'dimou', '邓梅',
       ...
       ('eimou', 'wx_union_eimou', 'mp_open_eimou', 'eimou@example.com', '13800138005', '370101199105052345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'eimou', '易萌',
       ...
       ('fimou', 'wx_union_fimou', 'mp_open_fimou', 'fimou@example.com', '13800138006', '370101199206062345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'fimou', '范敏',
       ...
       ('gimou', 'wx_union_gimou', 'mp_open_gimou', 'gimou@example.com', '13800138007', '370101199307072345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'gimou', '高梅',
       ...
       ('himou', 'wx_union_himou', 'mp_open_himou', 'himou@example.com', '13800138008', '370101199408082345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'himou', '黄敏',
       ...
       ('iimou', 'wx_union_iimou', 'mp_open_iimou', 'iimou@example.com', '13800138009', '370101199509092345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'iimou', '冯萌',
       ...
       ('jimou', 'wx_union_jimou', 'mp_open_jimou', 'jimou@example.com', '13800138010', '370101199610102345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'jimou', '贾梅',
       ...
       ('kimou', 'wx_union_kimou', 'mp_open_kimou', 'kimou@example.com', '13800138011', '370101199711112345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'kimou', '康铭',
       ...
       ('mimou', 'wx_union_mimou', 'mp_open_mimou', 'mimou@example.com', '13800138016', '370101200204162345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'mimou', '莫敏',
       ...
       ('nimou', 'wx_union_nimou', 'mp_open_nimou', 'nimou@example.com', '13800138017', '370101200305172345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'nimou', '牛梅',
       ...
       ('oimou', 'wx_union_oimou', 'mp_open_oimou', 'oimou@example.com', '13800138018', '370101200406182345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'oimou', '欧阳敏',
       ...
       ('pimou', 'wx_union_pimou', 'mp_open_pimou', 'pimou@example.com', '13800138019', '370101200507192345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'pimou', '潘萌',
       ...
       ('qimou', 'wx_union_qimou', 'mp_open_qimou', 'qimou@example.com', '13800138020', '370101200608202345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'qimou', '曲敏',
       ...
       ('rimou', 'wx_union_rimou', 'mp_open_rimou', 'rimou@example.com', '13800138021', '370101200709212345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'rimou', '任梅',
       ...
       ('simou', 'wx_union_simou', 'mp_open_simou', 'simou@example.com', '13800138022', '370101200810222345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'simou', '孙萌',
       ...
       ('timou', 'wx_union_timou', 'mp_open_timou', 'timou@example.com', '13800138023', '370101200911232345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'timou', '陶敏',
       ...
       ('uimou', 'wx_union_uimou', 'mp_open_uimou', 'uimou@example.com', '13800138024', '370101201012242345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'uimou', '吴梅',
       ...
       ('vimou', 'wx_union_vimou', 'mp_open_vimou', 'vimou@example.com', '13800138025', '370101201112252345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'vimou', '韦敏',
       ...
       ('wimou', 'wx_union_wimou', 'mp_open_wimou', 'wimou@example.com', '13800138026', '370101201212262345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'wimou', '魏萌',
       ...
       ('ximou', 'wx_union_ximou', 'mp_open_ximou', 'ximou@example.com', '13800138027', '370101201312272345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'ximou', '谢敏',
       ...
       ('yimou', 'wx_union_yimou', 'mp_open_yimou', 'yimou@example.com', '13800138028', '370101201412282345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'yimou', '杨萌',
       ...
       ('zimou', 'wx_union_zimou', 'mp_open_zimou', 'zimou@example.com', '13800138029', '370101201512292345',
        '5be35df1ff07a29e983bcbaef710626f', 'https://wci-1318277926.cos.ap-guangzhou.myqcloud.com/work-collaborative-images/logo.png', '["tag"]', 'zimou', '张敏',
