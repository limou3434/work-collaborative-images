...
(
    ...
    `space_id`       BIGINT               DEFAULT NULL COMMENT '空间 id(为 null 表示公共空间)',
...
(
    ...
    `name`        VARCHAR(128)      NULL COMMENT '空间名称',
    `level`       INT     DEFAULT 0 NULL COMMENT '空间级别: 0-普通版 1-专业版 2-旗舰版',
    ...
    INDEX `idx_space_name` (`name`),
    INDEX `idx_space_level` (`level`)
